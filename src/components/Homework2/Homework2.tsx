...
const Homework2: React.FC = () => {
    ...
    return (
        <div>
            ...
            <div>
                <button className="hw2-btn" onClick={addComponent}>Add Component</button>
                <button className="hw2-btn remove" onClick={() => removeComponent()}>Remove Component</button>
                    ...
                    {components.map((comp, index) => (
                        ...
                        >
                            ...
                            <button
                                ...
                                style={{ float: 'right', padding: '0.3rem 0.7rem', fontSize: '0.9rem', marginRight: 0 }}
